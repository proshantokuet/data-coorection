...
public class PatientTest extends TestResourceLoader {
	...
	public void shouldCreatePerson() throws JSONException {
		...
		Client c = new Client()
		        .withBaseEntity(
		            new BaseEntity(UUID.randomUUID().toString(), "FN", "MN", "LN", new Date(), new Date(), true, false,
		                    "MALE", addresses, attribs))
	...
	@Test
	public void shouldUploadFile() throws IOException, JSONException {
		System.err.println("" + s);
		System.err.println("SS:" + s.getPatientByIdentifier("f529e9e0-dca6-4129-950c-c354d53b397c"));
